...
const apiKey = '4642742c6682a15ee46795cd9d26b242';
...
async function getFetchData(endPoint, city) {
    ...
    try {
        ...
        return { status: 500 }; // Simulate server error.
    }
}
...
async function updateForecastInfo(city) {
    ...
    if (forecastData.status && forecastData.status !== 200) {
    ...
    forecastItemContainer.innerHTML = ''; // Clear previous items
